...
$(PREFIX)/lib/python$(PYTHON3_SHORT_VERSION)/site-packages/eccodes-$(VERSION)-py$(PYTHON3_SHORT_VERSION).egg-info:
	...
	$(MAKE) --file=$(MFEXT_HOME)/share/Makefile.standard PREFIX=$(PREFIX) EXPLICIT_NAME="$(EXPLICIT_NAME)" OPTIONS="-DBUILD_SHARED_LIBS=ON -DENABLE_FORTRAN=OFF -DENABLE_NETCDF=OFF -DENABLE_PYTHON=ON -DENABLE_JPG=ON -DOPENJPEG_PATH=$(PREFIX)/../scientific_core" download uncompress configure_cmake python3pyinstall_cmake
	rm -f build/$(NAME)-$(VERSION)-Source/build/lib/libeccodes.so
