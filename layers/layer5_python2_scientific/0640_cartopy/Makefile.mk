...
$(PREFIX)/lib/python$(PYTHON2_SHORT_VERSION)/site-packages/Cartopy-0.13.1-py$(PYTHON2_SHORT_VERSION)-linux-x86_64.egg:
	$(MAKE) --file=$(MFEXT_HOME)/share/Makefile.standard PREFIX=$(PREFIX) EXTRACFLAGS="-I$(PREFIX)/../scientific_core/include" EXTRALDFLAGS="-L$(PREFIX)/../scientific_core/lib" download uncompress python2build python2install
