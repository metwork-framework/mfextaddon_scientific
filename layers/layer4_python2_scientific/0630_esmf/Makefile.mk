...
all:: $(PREFIX)/lib/python$(PYTHON2_SHORT_VERSION)/site-packages/ESMPy-$(VERSION_PYTHON)-py$(PYTHON2_SHORT_VERSION).egg-info
$(PREFIX)/lib/python$(PYTHON2_SHORT_VERSION)/site-packages/ESMPy-$(VERSION_PYTHON)-py$(PYTHON2_SHORT_VERSION).egg-info:
